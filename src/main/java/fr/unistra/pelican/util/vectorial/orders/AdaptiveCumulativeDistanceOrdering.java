...
public class AdaptiveCumulativeDistanceOrdering implements VectorialOrdering
{
	private double[] d = null;
	private AdaptiveWeightedOrdering4 awo;
	
	public AdaptiveCumulativeDistanceOrdering(AdaptiveWeightedOrdering4 awo)
	{
		this.awo = awo;
	}
	...
	{
		double dist = Math.abs(awo.scalarize(p1) - awo.scalarize(p2));
