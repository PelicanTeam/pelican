...
public class AdaptiveWeightedOrdering4 implements VectorialOrdering,Comparator
{
	...
	public AdaptiveWeightedOrdering4(double refHue)
	{
		this.refHue = refHue;
		slope = 5.0;
		offset = 0.5;
	...
	public AdaptiveWeightedOrdering4(double offset,double slope,double refHue)
	{
		this.refHue = refHue;
	...
	public AdaptiveWeightedOrdering4(double offset,double slope,double refHue,double offset2,double slope2)
	{
		this.refHue = refHue;
