 ...
 * 
 * Bu da olayin tersi kocum...yani yuksek olasilik olunca cok boluyoruz...
 * 
...
public class DynamicHSLAlphaLexicographicalOrderingTers implements VectorialOrdering,Comparator
{
	 ...
	 */
	public DynamicHSLAlphaLexicographicalOrderingTers(double alpha,int order,double refHue,double[][] histo)
	{
		...
		for(int i = 1; i < 256; i++){
			...
			double sigma = 1 / (1 + Math.exp(-450 * (avg - mean)));
			...
			birimSys = width - birimSys;	// tersine cevir etkiyi
