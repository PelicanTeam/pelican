...
/**
 * This class represents a reduced lexicographical ordering scheme for double valued arrays and derivatives. 
 * The euclidean norm is used as the first comparison component.
 * 
 * @author E.A.
 *
 */

public class ReducedLexicographicalOrdering implements VectorialOrdering,Comparator
{
	/*
	 *  (non-Javadoc)
	...
	public int compare(Object o1,Object o2)
	{
		...
		double norm1 = Tools.euclideanNorm(p1);
		double norm2 = Tools.euclideanNorm(p2);
