...
public class Neighbourhood2D {
	...
	/**
	 * Returns the point of the backward semi 4-neighbourhood
	 * (-1,0),(0,-1) 
	 * @return backward semi 4-neighbourhood
	 */
	public static Point[] getBackwardSemi4Neighboorhood()
	{
		Point[] neighbourhood = {new Point(-1,0),new Point(0,-1)};
		return neighbourhood;
	}
	
	/**
	 * Returns the point of the forward semi 4-neighbourhood
	 * (1,0),(0,1)
	 * @return forward semi 4-neighbourhood
	 */
