 ...
 *
 */
public class AttributeColor1 extends ComponentAttribute<Double> {

	private int b1;
	
	private int b2;
	
	public AttributeColor1(int b1, int b2)
	{
		this.b1=b1;
		this.b2=b2;
	}
	
	public AttributeColor1(int b1, int b2,double d) {
		this.b1=b1;
		this.b2=b2;
		this.value=d;
	}
	...
	public <T> void computeAttribute(ComponentTree<T> c)
		...
		for (ComponentNode<T> n : c.iterateFromLeafToRoot()) {
			...
			n.add(new AttributeColor1(b1,b2,(sum[b1]-sum[b2])));
		}
