...
/**
 * Computes the vectorial maximum of two images. 
...
public class VectorialMaximum extends Algorithm {
	...
	/**
	 * Vectorial supremum of inputs with respect to the VectorialOrdering chosen
	 */
	public Image output;
	...
	public void launch() throws AlgorithmException {
		...
		for ( int y = 0 ; y < input1.getYDim() ; y++ ) { 
			...
			if ( isHere1 && !isHere2 ) 
				output.setVectorPixelXYZTDouble(x, y, 0, 0, vo.max(p1, p2));
	 ...
	 * @return Vectorial maximum of inputs
	 */
	public static Image exec(Image input1, Image input2, BinaryVectorialOrdering vo) {
		return (Image)new VectorialMaximum().process(input1, input2,vo);
	}
}
