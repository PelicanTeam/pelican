...
/**
 * Perform a soft classification using the Naive Bayes Weka algorithm. Each band
 * from input represents a attribute. Each band from samples represent a class
 * exemples.
...
public class WekaSoftClassificationNaiveBayes extends Algorithm {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Image work = (Image) new WekaSoftClassificationNaiveBayes().process(source,
					samples);
