 ...
 */
public class WekaSoftClassification50NN extends Algorithm {
	 ...
	 * 
	 */
	public WekaSoftClassification50NN() {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Image work = (Image) new WekaSoftClassification50NN().process(source, samples);
