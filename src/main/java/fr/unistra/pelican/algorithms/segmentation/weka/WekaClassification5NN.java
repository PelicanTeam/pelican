...
/**
 * Perform a classification using the 5-Nearest Neighbour Weka algorithm. Each
 * band from input represents a attribute. Each band from samples represent a
 * class exemples.
 * @author Sébastien Derivaux
 */
public class WekaClassification5NN extends Algorithm {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Image work = (Image) new WekaClassification5NN().process(source, samples);
