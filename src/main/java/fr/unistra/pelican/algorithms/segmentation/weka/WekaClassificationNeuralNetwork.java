...
/** 
 * Perform a classification using the Multilayer Perceptron Weka algorithm. Each
 * band from input represents a attribute. Each band from samples represent a
 * class exemples.
 * @author Sébastien Derivaux
 */
public class WekaClassificationNeuralNetwork extends Algorithm {
	 ...
	 * 
	 */
	public WekaClassificationNeuralNetwork() {

		super();
		super.inputs = "inputImageLearn,samples";
	...
	public static void main(String[] args) {
		...
		try {
			...
			Image work = (Image) new WekaClassificationNeuralNetwork().process(source,
					samples);
