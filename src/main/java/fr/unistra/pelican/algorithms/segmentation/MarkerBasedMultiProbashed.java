...
public class MarkerBasedMultiProbashed extends Algorithm {
	 ...
	 * 
	 */
	public MarkerBasedMultiProbashed() {
	...
	public void launch() throws AlgorithmException {
		...
		outputImage = MarkerBasedMultiWatershed.exec(relief);
	...
	public static IntegerImage exec(Image image, Image samples, double weight,
		...
		return (IntegerImage) new MarkerBasedMultiProbashed().process(image,
