...
/**
 * This class performs a vectorial erosion with the given structuring element on a double
 * precision
 * 
 * @author Abdullah
 */
public class VectorialErosion extends Algorithm
{
	/**
	 * the input image
	 */
	...
	/**
	 * This method performs a vectorial erosion with the given structuring element and ordering
	...
	public static Image exec(Image inputImage,BooleanImage se,VectorialOrdering vo) {
		return (Image) new VectorialErosion().process(inputImage,se,vo);
	}
	...
	private double[] getMinVector(int x, int y, int z, int t, Point4D[] points) {
	...
	public void launch() throws AlgorithmException {
		...
		for ( int x = 0 ; x < xDim ; x++ )
			if ( inputImage.isPresentXYZT( x,y,z,t ) )
				outputImage.setVectorPixelXYZTDouble(x,y,z,t,getMinVector(x, y, z, t, points));
	}
}
