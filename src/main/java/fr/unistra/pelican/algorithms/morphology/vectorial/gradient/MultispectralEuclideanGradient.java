 ...
 * 
 */
public class MultispectralEuclideanGradient extends Algorithm {
	/**
	 * the input image
	 */
	...
	public static Image exec(Image inputImage, BooleanImage se) {
		return (Image) new MultispectralEuclideanGradient().process(inputImage, se);
	}
	 ...
	 * 
	 */
	public MultispectralEuclideanGradient() {
