...
/**
 * This class performs a vectorial reconstruction by erosion with the given structuring
 * element, mask and vectorial ordering. Works on double precision. Output
 * format is the same as mask.
 * 
 * @author Abdullah
 */
public class VectorialReconstructionByErosion extends Algorithm
{
	/**
	 * the input image
	 */
	...
	/**
	 * This class performs a vectorial reconstruction by erosion with the given structuring element, mask and vectorial ordering.
	 * 
	...
	public static Image exec(Image image, Image mask,BooleanImage se,VectorialOrdering vo) {
		return (Image) new VectorialReconstructionByErosion().process(image,mask,se,vo);
	}
	 ...
	 * 
	 */
	public VectorialReconstructionByErosion() {
	...
	public void launch() throws AlgorithmException {
		...
		try {
			...
			do {
				outputImage = tmp;
				tmp = (Image) new VectorialGeodesicErosion().process( outputImage, mask, se, vo );
