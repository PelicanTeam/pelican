 ...
 *	@date 29/05/2009
 * 
 *	@author Erchan Aptoula (theory)
 *	@author Régis Witz (coding)
 */
public class ColorSpecificGranulometry extends Descriptor { 
	...
	public static DoubleArrayData exec( Image input ) { 
		return ( DoubleArrayData ) new ColorSpecificGranulometry().process( input );
	}

	public static DoubleArrayData exec( Image input, int length ) { 
		return ( DoubleArrayData ) new ColorSpecificGranulometry().process( input,length );
	}
