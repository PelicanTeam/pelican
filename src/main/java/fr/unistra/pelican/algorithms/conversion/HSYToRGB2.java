...
public class HSYToRGB2 extends Algorithm {
	 ...
	 */
	private static int[] convert(double H, double S, double Y) {
		int[] rgb = new int[3];
		...
		R = 1.0 * Y + 0.667 * C1 + 0.0 * C2;
		G = 1.0 * Y - 0.333 * C1 - 0.5773502691896258 * C2;
		B = 1.0 * Y - 0.333 * C1 + 0.5773502691896258 * C2;
	...
	public static Image exec(Image input) {
		return (Image) new HSYToRGB2().process(input);
	}
}