...
public class RGBToHSY extends Algorithm {
	...
	public static double[] convert(int r, int g, int b) {
		...
		// luminance => does not take into account the non-linear response
		// of the human eye.
		hsy[2] = 0.299 * rN + 0.587 * gN + 0.114 * bN;
		// hsy[2] = Math.pow(hsy[2],0.333333);
	...
	public static Image exec(Image input) {
		return (Image) new RGBToHSY().process(input);
	}
}
