...
public class LCHToLAB extends Algorithm {
	...
	/**
	 * converts a triplet of lch into cielab
	 * 
	 * @param l
	 * @param c
	 * @param h
	 ...
	 */
	public static double[] convert(double l, double c, double h) {
	...
	/**
	 * Realizes the transformation of a tristumulus double valued CIE LCH image
	 * into a CIE LAB image.
	 * 
	 * @param input
	...
	public static Image exec(Image input) {
		return (Image) new LCHToLAB().process(input);
	}
}