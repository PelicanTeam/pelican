...
/**
 * This class represents the isotropic edge detector scheme, applied as norm,
 * horizontal,vertical and orientation gradient.
 * 
 * @author Abdullah
 */
public class Isotropic extends Algorithm {
