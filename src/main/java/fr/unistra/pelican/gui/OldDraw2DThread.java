 ...
 * 
 */
public class OldDraw2DThread extends JPanel implements Runnable, WindowListener{
	...
	/**
	 * Instance of OldMarkerDisplayJAI
	 */
	 ...
	 */
	public OldDraw2DThread(Image inputImage, String title, Object callingObj) {
	...
	private void guiInitialisation() {
		...
		// Component which contains tha OldMarkerDisplayJAI instance (display)
		...
		labelComboBox.addItem("Label 0 ");
		labelComboBox.addItem("Label 1 ");
		labelComboBox.setSelectedIndex(1);
		labelComboBox.addActionListener(new OldDraw2Dv2_labelComboBox_actionAdapter(
				this));

		plusButton.setText("+");
		plusButton.addActionListener(new OldDraw2Dv2_plusButton_actionAdapter(this));
		...
		brushSpinner.addChangeListener(new OldDraw2Dv2_brushSpinner_actionAdapter(
				this));
		...
		transparencySlider
				.addChangeListener(new OldDraw2Dv2_transparencySlider_changeAdapter(
						this));

		undoButton.setText("Undo");
		undoButton.addActionListener(new OldDraw2Dv2_undoButton_actionAdapter(this));
		jPanel3.add(undoButton, BorderLayout.WEST);
		undoButton.setEnabled(false);

		okButton.setText("Ok");
		okButton.addActionListener(new OldDraw2Dv2_okButton_actionAdapter(this));
		jPanel3.add(okButton, BorderLayout.EAST);
		okButton.setEnabled(false);

		resetButton.setText("Reset");
		resetButton
				.addActionListener(new OldDraw2Dv2_resetButton_actionAdapter(this));
	 ...
	 */
	public class OldDraw2Dv2_brushSpinner_actionAdapter implements
			javax.swing.event.ChangeListener {
		OldDraw2DThread d2d;

		OldDraw2Dv2_brushSpinner_actionAdapter(OldDraw2DThread d2d) {
			this.d2d = d2d;
		}
	 ...
	 */
	public class OldDraw2Dv2_undoButton_actionAdapter implements
			java.awt.event.ActionListener {
		OldDraw2DThread d2d;

		OldDraw2Dv2_undoButton_actionAdapter(OldDraw2DThread d2d) {
			this.d2d = d2d;
		}
	 ...
	 */
	public class OldDraw2Dv2_labelComboBox_actionAdapter implements
			java.awt.event.ActionListener {
		OldDraw2DThread d2d;

		OldDraw2Dv2_labelComboBox_actionAdapter(OldDraw2DThread d2d) {
			this.d2d = d2d;
		}
	 ...
	 */
	public class OldDraw2Dv2_okButton_actionAdapter implements
			java.awt.event.ActionListener {
		OldDraw2DThread d2d;

		OldDraw2Dv2_okButton_actionAdapter(OldDraw2DThread d2d) {
			this.d2d = d2d;
		}
	 ...
	 */
	public class OldDraw2Dv2_resetButton_actionAdapter implements
			java.awt.event.ActionListener {
		OldDraw2DThread d2d;

		OldDraw2Dv2_resetButton_actionAdapter(OldDraw2DThread d2d) {
			this.d2d = d2d;
		}
	 ...
	 */
	public class OldDraw2Dv2_plusButton_actionAdapter implements
			java.awt.event.ActionListener {
		OldDraw2DThread d2d;

		OldDraw2Dv2_plusButton_actionAdapter(OldDraw2DThread d2d) {
			this.d2d = d2d;
		}
	 ...
	 */
	public class OldDraw2Dv2_transparencySlider_changeAdapter implements
			javax.swing.event.ChangeListener {
		OldDraw2DThread d2d;

		OldDraw2Dv2_transparencySlider_changeAdapter(OldDraw2DThread d2d) {
			this.d2d = d2d;
		}
	...
	/**
	 * The OldMarkerDisplayJAI handles all theimage traitments, including for the
	...
	class OldMarkerDisplayJAI extends DisplayJAI {
		...
		/**
		 * Method which sets the background with no image and creates the
		 * invisible image based on the dimension given in parameter
		 * 
		 * @param sizeX
		 * @param sizeY
		 */
		public void set(int sizeX, int sizeY) {

			// Create a marker image without an alpha channel,
			markerImage1 = ImageCreator.createGrayImage(sizeX, sizeY);
