...
public class InputLongArray extends JPanel implements InputType,
		ActionListener {
	 ...
	 */
	public InputLongArray(GlobalController controller, String algoName,
	...
	public void fire() {
		...
		for (int i = 0; i < arraySize; i++) {
			...
			if (textfield.getText().equals("Default")) {
				...
				result[i] = Long.valueOf(textfield.getText());
			}
		}
		...
		if (misfilled == true) {
			if (option == false) {
				System.err
						.println("ERROR: The long parameter is mandatory, one parameter is not well filled");
			} else {
