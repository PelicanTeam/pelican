...
public class InputFloatArray extends JPanel implements InputType,
		ActionListener {
	 ...
	 */
	public InputFloatArray(GlobalController controller, String algoName,
	...
	public void fire() {
		...
		for (int i = 0; i < arraySize; i++) {
			...
			if (textfield.getText().equals("Default")) {
				...
				result[i] = Float.valueOf(textfield.getText());
			}
		}
		...
		if (misfilled == true) {
			if (option == false) {
				System.err
						.println("ERROR: The float parameter is mandatory, one parameter is not well filled");
			} else {
