...
public class InputInteger extends JPanel implements InputType {
	 ...
	 */
	public InputInteger(GlobalController controller, String algoName,
	...
	public void parameterSeizing(GlobalController controller, String algoName,
		...
		tf = new JTextField(Integer.toString(i));
		this.add(tf);
