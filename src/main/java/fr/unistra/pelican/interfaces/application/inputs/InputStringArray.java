...
public class InputStringArray extends JPanel implements InputType,
		ActionListener {
	 ...
	 */
	public InputStringArray(GlobalController controller, String algoName,
	...
	public void fire() {
		...
		if (misfilled == true) {
			if (option == false) {
				System.err
						.println("ERROR: The String parameter is mandatory, one parameter is not well filled");
			} else {
