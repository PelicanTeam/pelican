...
public class InputLong extends JPanel implements InputType {
	 ...
	 */
	public InputLong(GlobalController controller, String algoName,
	...
	public void parameterSeizing(GlobalController controller, String algoName,
		...
		tf = new JTextField(Long.toString(i));
		this.add(tf);
	...
	public void fire() {
		...
		result = Long.valueOf(tf.getText());
		if (option == false) {
