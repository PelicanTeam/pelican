...
public class InputDoubleArray extends JPanel implements InputType,
		ActionListener {
	 ...
	 */
	public InputDoubleArray(GlobalController controller, String algoName,
	...
	public void fire() {
		...
		for (int i = 0; i < arraySize; i++) {
			...
			if (textfield.getText().equals("Default")) {
				...
				result[i] = Double.valueOf(textfield.getText());
			}
		}
